...
public abstract class ListTest {
    ...
    public final void testMoveToFinishShowBug() {
         ...
         * Set up variables
         */
        List<String> listTest = this.createFromArgsTest(0);
        List<String> listRef = this.createFromArgsRef(0, "red");
        /*
         * Call method under test
         */
         ...
         */
        listTest.addRightFront("red");
        assertEquals(listRef, listTest);
    }

    @Test
    public final void testMoveToFinishShowBugWithMovement() {
        /*
         * Set up variables
         */
        List<String> listTest = this.createFromArgsTest(0, "green");
        List<String> listRef = this.createFromArgsRef(1, "green", "red");
        /*
         * Call method under test
         */
        listTest.moveToFinish();
